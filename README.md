...
plan/           phase plans + execution log (findings F1-F66)
...
| [`plan/execution_plan_log.md`](plan/execution_plan_log.md) | Findings F1–F66, dated. Also the architecture changelog |
| [`mistakes.md`](mistakes.md) | Every defect found, in plain terms — eleven of twelve did not crash |
