...
plan/           phase plans + execution log (findings F1-F61)
...
| [`plan/execution_plan_log.md`](plan/execution_plan_log.md) | Findings F1–F61, dated. Also the architecture changelog |
