...
plan/           phase plans + execution log (findings F1-F63)
...
| [`plan/execution_plan_log.md`](plan/execution_plan_log.md) | Findings F1–F63, dated. Also the architecture changelog |
| [`mistakes.md`](mistakes.md) | Every defect found, in plain terms — nine of ten did not crash |
